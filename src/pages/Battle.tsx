...
import { FeeChart } from "../components/Platform";
export default function Battle() {
  ...
  async function share() {
    try {
      await navigator.clipboard.writeText(`${location.origin}/arena/season-01`);
    ...
    <div className="page battle-page">
      ...
      <div className="battle-lower">
        ...
        <section className="war-wire">
          <div className="section-heading">
            <h2>THE WAR WIRE</h2>
            <Link to="/numbers#activity" aria-label="View all activity">
