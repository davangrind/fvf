    ...
    >
      ...
      <div className="arena-stage">
        <div className="arena-countdown preparation-card">
          <small>EVENT 001 / RECRUITING</small>
          <strong>PREPARATION MODE</strong>
          <span>Launch a token. Back your side.</span>
        </div>
            ...
            >
              ...
              <div className="fighter-copy">
                ...
                <span className={`stage-stamp ${lead ? "leading" : ""}`}>
                  {lead ? (
                    <>
                      <TrendingUp size={10} /> CURRENT MENACE
                    </>
                  ) : (
                    <>
                      <Crosshair size={10} /> CALCULATING REVENGE
                    </>
                  )}
                </span>
              </div>
              ...
              <span className="debris debris-one">
                <Crosshair size={15} />
              </span>
              <span className="debris debris-two">
                <Plus size={16} />
              </span>
              <span className="debris debris-three">
                <Sparkles size={14} />
              </span>
            </div>
          );
        ...
        <span className="arena-scribble">
          choose your
          <br />
          bad influence <ArrowUpRight size={14} />
        </span>
        {phase === "fighting" && (
          <div
          ...
          >
            ...
            <span className="collision-spark">
              <Zap size={90} />
            </span>
      ...
      >
        ...
        <span className="control-caption">FEE POOL SHARE</span>
      </div>
